...
(deffacts symptomReason
   ...
   (Reason (name Nausea)(type SYMPTOM)(explanation "Nausea is caused by gastroparesis.")(extraInfo "Gastroparesis is a disease of the muscles of the stomach or the nerves controlling the muscles that causes the muscles to stop working, affecting the digestive process"))
   ...
   (Reason (name Yeast-Infection)(type SYMPTOM)(explanation "Yeast organisms are present in most woman, but these organisms tend to overgrow in a sugar rich environment. A result of badly managed diabetes")(extraInfo "Yeast is a type of fungus; yeast infection refers to the fungus scientifically known as Candida"))
   ...
   (Reason (name Gum-Infection)(type SYMPTOM)(explanation "High glucose levels in saliva promotes growth of bacteria that cause gum disease.") (extraInfo "Diabetes reduces the body’s resistance to infection, which increases the probability of the gums becoming infected."))
...
(defrule getSymptom
    ...
    (Reason (name ?symptom)(type SYMPTOM)(url ?url)(explanation ?explanation)(extraInfo ?additional))
    =>
