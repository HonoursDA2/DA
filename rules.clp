...
(deffacts Questions
    ...
    (Question (section Initial)(type "Age")(text "How old are you?") (answerType "INPUTN") (order 2))
    (Question (section Initial)(type "Gender")(text "Are you male or female?")(answerType "MALE-FEMALE") (order 3))
    (Question (section Initial)(type "Race")(text "What is your race?") (answerType "OPTIONAL")(order 4)(options "Black-White-Asian-Coloured-Other" ))
    (Question (section Initial)(type "Weight")(text "What is your weight (Kilograms)")(answerType "INPUTND") (order 5))
    (Question (section Initial)(type "Height")(text "What is your height (Meters)") (answerType "INPUTND") (order 6))
    (Question (section Initial)(type "Diabetes-Knowledge")(text "Do you know about the disease called Diabetes?") (answerType "YES-NO") (order 7))
    (Question (section Initial)(type "Diabetic")(text "Are you a Diabetic?") (answerType "OPTIONAL") (order 8)(options "Yes-No-Uncertain" ))
    ...
    (Question (section Initial)(type "Family-Type")(text "Is this relative any of the following?")(answerType "MULTIPLE")(options "Parent-Child-Sibling-Grandparent-AuntOrUncle-Other" )(order 10))
...
(deffacts symptomReason
   ...
   (Reason (name Slow-Healing-Wounds)(type SYMPTOM)(url "wound.jpg")(points 8)(explanation "Slow Healing Wounds - Elevated blood sugar levels cause narrowing of blood vessels, leading to a decreased blood flow and oxygen to the wounds."))
   (Reason (name Numbness)(type SYMPTOM)(points 4)(url "numb.jpg")(explanation "Numbness - The nerves in the body get damaged over time, leading to a tingling sensation, pain and eventual loss of sensation"))
...
(defrule askQuestionInitial
    ...
    (printout out8(* (/ (- ?*nextQuestion* 1) ?*questionNumber*) 100))
...
(deffunction checkPercentage(?percentage)
...
(deffunction assessPercentage()
    ...
    (if (> ?percentage  75) then
       ( assert (Feedback (order ?*currentQuestion*) (stage FINAL) (explanation " You have a very high risk of Diabetes! This should be viewed as a great concern and should be dealt with immediately
        ...
        (bind ?percentage (* (/ ?*points* ?*total*) 100))
    	(bind ?number (checkPercentage ?percentage))    
    	(bind ?number (format nil %3.0f ?number))    
