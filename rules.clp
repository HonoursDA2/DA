...
(deffacts Questions
    ...
    (Question (section Initial)(type "weight")(text "What is your weight (KG)")(answerType "INPUTN") (order 9))
    (Question (section Initial)(type "height")(text "What is your height (M)") (answerType "INPUTN") (order 10))
