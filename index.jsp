...
<div id="symptoms">
<div class="buttons" id="thirst" value="Thirsty" onclick="clicked(thirst)">Thirst</div>
...
<div class="buttons" id="neusea" onclick="clicked(neusea)">Nausea</div>
<div class="buttons" id="abdomenalpain" onclick="clicked(abdomenalpain)">Irritability</div>
<div class="buttons" id="yeast" onclick="clicked(yeast)">Yeast Infection</div>
<div class="buttons" id="wounds" onclick="clicked(wounds)">Slow Healing of Wounds</div>
<div class="buttons" id="numbness" onclick="clicked(numbness)">Numbness</div>
<div class="buttons" id="teethandgum" onclick="clicked(teethandgum)">Teeth and gum problems</div>
<div class="buttons" id="hunger" onclick="clicked(hunger)">Extreme Hunger</div>
